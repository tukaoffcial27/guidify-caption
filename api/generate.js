...
export default async function (req) {
    ...
    try {
        ...
        // MENGGUNAKAN MODEL YANG TERSEDIA DI AKUN ANDA (GEMINI 3 FLASH)
        ...
        const response = await fetch(apiUrl, {
            ...
            body: JSON.stringify({
                contents: [{ parts: [{ text: `Write a viral social media caption for ${platform}. Topic: ${topic}. Tone: ${tone}. Language: English. Include emojis and hashtags.` }] }]
            })
        });
